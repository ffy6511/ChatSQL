...
export const tutorials: TutorialData[] = [
  ...
  {
    title: "GROUP BY分组操作",
    description: " 介绍SQL中GROUP BY子句的用法，学习如何对数据进行分组和分组后的筛选。",
    problem: [
  ...
  {
    title: "聚合函数操作",
    description: " 介绍SQL中常用的聚合函数，如COUNT、SUM、AVG、MAX和MIN等，学习如何进行数据汇总和统计分析。",
    problem: [
  ...
  {
    title: "JOIN表连接操作",
    description: " 介绍SQL中的JOIN操作，学习如何连接多个表进行查询，包括INNER JOIN、LEFT JOIN等不同类型的连接。",
    problem: [
  ...
  {
    title: "嵌套子查询操作",
    description: " 介绍SQL中的嵌套子查询，学习如何在一个查询中嵌套另一个查询，实现更复杂的数据筛选和分析。",
    problem: [
  ...
  {
    title: "数据库查询",
    description: "这是Database System Concepts(Seventh Edition)的Schema diagram for the university database. 为zjuer的DB课程所准备, 部分字段根据教学PPT的定义更改, 与官网不完全一致.",
    problem: [
      "请在此处发挥您的想象力~"
    ],
    ...
    tuples: [
      ...
      },
      {
        tableName: "department",
        tupleData: [
          { dept_name: "Biology", building: "Watson", budget: 90000.00 },
          { dept_name: "Comp. Sci.", building: "Taylor", budget: 100000.00 },
          { dept_name: "Elec. Eng.", building: "Taylor", budget: 85000.00 },
          { dept_name: "Finance", building: "Painter", budget: 120000.00 },
          { dept_name: "Physics", building: "Watson", budget: 70000.00 }
        ]
      },
      {
        tableName: "course",
      ...
      },
      {
        tableName: "instructor",
        tupleData: [
          { ID: "10101", name: "张三", dept_name: "Comp. Sci.", salary: 65000.00 },
          { ID: "12121", name: "李四", dept_name: "Finance", salary: 90000.00 },
          { ID: "15151", name: "王五", dept_name: "Comp. Sci.", salary: 75000.00 },
          { ID: "22222", name: "赵六", dept_name: "Physics", salary: 95000.00 },
          { ID: "32343", name: "钱七", dept_name: "Elec. Eng.", salary: 80000.00 }
        ]
      },
      {
        tableName: "section",
      ...
      },
      {
        ...
        tupleData: [
          ...
          { ID: "15151", course_id: "CS-101", sec_id: "1", semester: "Spring", year: 2018 },
      ...
      },
      {
        tableName: "student",
        tupleData: [
          { ID: "00128", name: "张小明", dept_name: "Comp. Sci.", tot_cred: 102 },
          { ID: "12345", name: "李小红", dept_name: "Comp. Sci.", tot_cred: 32 },
      ...
      },
      {
        ...
        tupleData: [
          ...
          { ID: "19991", course_id: "PHY-101", sec_id: "1", semester: "Fall", year: 2017, grade: "B+" },
      ...
      },
      {
        tableName: "time_slot",
        tupleData: [
          { time_slot_id: "A", day: "M", start_time: "08:00:00", end_time: "08:50:00" },
          { time_slot_id: "A", day: "W", start_time: "08:00:00", end_time: "08:50:00" },
          { time_slot_id: "B", day: "M", start_time: "09:00:00", end_time: "09:50:00" },
          { time_slot_id: "C", day: "M", start_time: "11:00:00", end_time: "11:50:00" },
          { time_slot_id: "H", day: "F", start_time: "10:00:00", end_time: "10:50:00" }
        ]
      },
      {
        tableName: "prereq",
